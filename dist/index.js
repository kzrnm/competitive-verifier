...
function loadConfigFromInput(core) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const tomlConfig = yield (() => __awaiter(this, void 0, void 0, function* () {
            if (!configFilePath) {
            ...
            let buf;
            try {
                buf = yield fs.readFile(configFilePath);
            }
            catch (error) {
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const config = yield (0, config_1.loadConfigFromInput)(core);
            core.debug(`config: ${config}`);
            yield new verify_1.OnlineJudgeVerify(core).run(config);
        }
        catch (error) {
...
class OnlineJudgeVerify {
    ...
    run(config) {
        return __awaiter(this, void 0, void 0, function* () {
            this.config = config;
            yield this.runVerify();
            if (config.createTimestamps)
                yield this.createTimestamps(config.timestampsFilePath);
            if (config.createDocs)
                yield this.createDocuments();
        });
    }
    /**
     * runVerify
     ...
     * createTimestamps
     */
    createTimestamps(timestampsFilePath) {
        return __awaiter(this, void 0, void 0, function* () { });
    }
    /**
     * createDocuments
